...
def create_experiment(ensemble_member_name=ps.ensemble_name,
    ...
    pae.write_pism_runscript(up_settings, up_settings.submit_template, runscript_path,
                             ...
                             create_smoothing_script = up_settings.create_smoothing_script,
                             create_full_physics_script = up_settings.create_full_physics_script,
                             create_paleo_script = up_settings.create_paleo_script)
